    ...
    <div className="w-screen h-screen bg-green-50 flex justify-center items-center">
      <form>
        <button
          ...
          className="text-white bg-green-500 hover:bg-green-600 hover:drop-shadow-xl transition-all duration-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center"
        >
          <svg
            ...
            height="16"
            fill="currentColor"
            className="bi bi-spotify w-5 h-5 me-2 -ms-1"
            viewBox="0 0 16 16"
          >
